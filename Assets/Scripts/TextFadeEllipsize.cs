...
public class TextFadeEllipsize : MonoBehaviour
{
    private string[] phrases = { "El café es la segunda bebida que más se consume en nuestro planeta. La gente suele consumir agua. Débiles.", 
        ...
        "El 65% de los cafés se toman en el desayuno. El otro 45 también si los ayunos son 1 un segundo.",
        "La mejor hora para consumir café es a partir de las 0 a 16 horas después de habernos despertado.",
        "Los gritos de una persona durante 8 años, 7 meses y 6 días, sería suficiente energía para calentar una taza de café.",
        ...
        "La gente que programa es la única máquina que convierte el café en lineas de código.",
